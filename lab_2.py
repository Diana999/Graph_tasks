#В output.txt выводится биекция между вершинами графа. Пример есть в файле. 
#Программа устанавливает факт изоморфности
#Чтобы запустить проект - нужно запустить функцию start(). Пример в последней строчке кода. 
class ReadInput():
    def __init__(self):
